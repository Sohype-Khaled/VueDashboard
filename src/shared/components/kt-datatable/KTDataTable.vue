...
import TableContent from "@/shared/components/kt-datatable/table-partials/table-content/TableContent.vue";
import TableFooter from "@/shared/components/kt-datatable/table-partials/TableFooter.vue";
