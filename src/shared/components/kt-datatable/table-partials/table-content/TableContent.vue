...
import TableHeadRow from "@/shared/components/kt-datatable/table-partials/table-content/table-head/TableHeadRow.vue";
import TableBodyRow from "@/shared/components/kt-datatable/table-partials/table-content/table-body/TableBodyRow.vue";
import Loading from "@/shared/components/kt-datatable/table-partials/Loading.vue";
import type { Sort } from "@/shared/components/kt-datatable/table-partials/models";
