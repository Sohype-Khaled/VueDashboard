...
import Results from "@/core/layouts/default-layout/components/search/partials/Results.vue";
import PartialMain from "@/core/layouts/default-layout/components/search/partials/Main.vue";
import Empty from "@/core/layouts/default-layout/components/search/partials/Empty.vue";
import MenuComponent from "@/shared/components/UI/UiMenu.vue";
