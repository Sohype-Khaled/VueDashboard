...
import type LayoutConfigTypes from "@/core/layouts/default-layout/config/types";
import layoutConfig from "@/core/layouts/default-layout/config/DefaultLayoutConfig";
